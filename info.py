...
API_ID = int(environ.get('API_ID', '25'))
API_HASH = environ.get('API_HASH', '61cc2f9591d90dfdd')
BOT_TOKEN = environ.get('BOT_TOKEN', '7259:AAH4BUhJ6vMEO89g')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002'))
